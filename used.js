...
async function fetchUsedDevices() {
    ...
    try {
        ...
        const devices = allProducts.filter(product => product.category === 'used');
                        ...
                        <div class="card product-card h-100 border-0">
                            ...
                            <div class="card-body d-flex flex-column">
                                ...
                                <div class="mt-auto">
                                    ...
                                    <a href="https://wa.me/201551714391?text=${encodeURIComponent('أهلاً دماغ.تك، عايز أستفسر عن ' + device.name)}" target="_blank" class="btn btn-whatsapp w-100 py-2">
